const V2POOLABI = [
  ...
  {
    anonymous: false,
    inputs: [{ indexed: true, internalType: 'address', name: 'communityVault_', type: 'address' }],
  ...
  {
    inputs: [
      { internalType: 'address', name: 'erc20Rebasing_', type: 'address' },
  ...
  },
  {
    inputs: [
      { internalType: 'address', name: 'erc20Rebasing_', type: 'address' },
      { internalType: 'enum YieldMode', name: 'mode_', type: 'uint8' },
    ],
    name: 'configure',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    stateMutability: 'nonpayable',
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'address', name: '_communityVault', type: 'address' },
    ],
    name: 'initialize',
    outputs: [],
    stateMutability: 'nonpayable',
  ...
  {
    inputs: [{ internalType: 'address', name: 'communityVault_', type: 'address' }],
    name: 'setCommunityVault',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
