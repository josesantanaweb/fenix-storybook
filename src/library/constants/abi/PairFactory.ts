...
const FACTORY_ABI: Abi = [
    ...
    inputs: [
      {
        indexed: true,
        internalType: 'address',
        name: 'communityVaultFactory',
        type: 'address',
      },
    ],
    name: 'SetCommunityVaultFactory',
    type: 'event',
  },
  {
    anonymous: false,
    ...
    name: 'SetConfigurationForRebaseToken',
    type: 'event',
  },
  {
    anonymous: false,
  ...
  },
  {
    ...
    name: 'configurationForBlastRebaseTokens',
    outputs: [
      {
        internalType: 'enum YieldMode',
        name: '',
