export const gammaHypervisorABI = [
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: 'uint8', name: 'newFee', type: 'uint8' }],
    name: 'SetFee',
    type: 'event',
  },
  {
...

  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'fees0', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'fees1', type: 'uint256' },
    ],
    name: 'ZeroBurn',
    type: 'event',
  },
  ...
  },
  {
    inputs: [],
    name: 'pool',
    outputs: [{ internalType: 'contract IAlgebraPool', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  { inputs: [], name: 'removeWhitelisted', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
  ...
  { inputs: [], name: 'toggleDirectDeposit', outputs: [], stateMutability: 'nonpayable', type: 'function' },
  {
    inputs: [],
    name: 'token0',
