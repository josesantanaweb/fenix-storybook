...
export default function Loader({ size = '1em', color = '' }: { size?: string | number; color?: string }) {
  return (
    <svg width={size} height={size} viewBox="0 0 95 95" fill="none" className="animate-spin">
      <path
        opacity="0.3"
      ...
      <defs>
        <linearGradient id="paint0_linear_1996_26244" x1="47.5" y1="0" x2="47.5" y2="95" gradientUnits="userSpaceOnUse">
          <stop stopColor="rgb(254,94,53)" />
          <stop offset="1" stopColor="rba(255,239,118)" />
        </linearGradient>
