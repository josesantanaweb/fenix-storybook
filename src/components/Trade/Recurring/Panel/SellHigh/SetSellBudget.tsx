...
const SetSellBudget = ({ token, setToken, setValue, value }: SetSellBudgetProps) => {
  ...
  return (
    <div className="exchange-box-x2">
      <div className="flex items-center justify-between mb-3">
        <p className="text-white text-sm">Set Sell Budget</p>
